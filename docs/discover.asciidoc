...
* Add the field to the Documents table. Click on the header of the column you want to sort by, it should display "Sort by [field name]" on mouseover. Clicking the field name a second time reverses the sort order.
